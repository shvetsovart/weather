<template>
  <div class="weather" :class="weatherClass">
    ...
    <div class="weather-bg">
      <div>
        <img src="./assets/bg.jpg" alt="App Background" class="weather-bg__img bg">
        <img src="./assets/overcast.jpg" alt="App Background" class="weather-bg__img overcast">
        <img src="./assets/partly-cloudy.jpg" alt="Partly Cloudy" class="weather-bg__img partly-cloudy">
        <img src="./assets/sunny.webp" alt="Sunny" class="weather-bg__img sunny">
      </div>
    </div>
  </div>
</template>
